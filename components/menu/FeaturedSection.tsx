...
export function FeaturedSection({
  ...
  return (
    <RevealOnScroll className="bg-cream py-10">
      ...
      <div className="no-scrollbar flex snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-1">
        {products.map((product) => (
          <button
            ...
            className="w-36 shrink-0 snap-start rounded-lg bg-cream-dark p-3 text-left shadow-[0_1px_3px_rgba(59,42,38,0.08)] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_8px_20px_rgba(59,42,38,0.12)] active:scale-[0.97]"
          >
